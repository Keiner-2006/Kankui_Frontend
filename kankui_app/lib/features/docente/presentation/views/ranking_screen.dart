...
class _RankingScreenState extends State<RankingScreen> {
  ...
  void initState() {
    super.initState();
    controller = Get.find<RankingController>();
    controller.initWith(widget.userProgress);
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() => SafeArea(
      child: controller.loading.value
          ...
          : RefreshIndicator(
              onRefresh: controller.cargarRanking,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              TextButton(
                                onPressed: controller.cargarRanking,
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildBuilderDelegate(
                          ...
                          childCount: controller.ranking.length,
                        ),
                      ),
                    ),
  ...
  Widget _buildNivelActual(BuildContext context) {
    final xpActual    = controller.userProgress.xpTotal;
    final nivelNumero = controller.obtenerNivelNumeroPorXP(xpActual);
    final nivelNombre = controller.obtenerNivelPorXP(xpActual);
    final progreso    = controller.calcularProgresoNivel(xpActual);
    final xpSiguiente = controller.calcularXPParaSiguienteNivel(xpActual);
          ...
          Row(
            ...
            children: [
              _buildStatItem(
                ...
                value: '${controller.userProgress.rachaDias}',
                label: 'Racha',
              ),
              _buildStatItem(
                context,
                icon: Icons.school_rounded,
                value: '${controller.userProgress.leccionesCompletadas}',
                label: 'Lecciones',
              ),
              _buildStatItem(
                context,
                icon: Icons.remove_red_eye_rounded,
                value: '${controller.userProgress.escaneoExitosos}',
                label: 'Escaneos',
              ),
            ],
          ),
  ...
  Widget _buildLogrosSection(BuildContext context) {
    final logrosObtenidos =
        controller.userProgress.logrosDesbloqueados ?? <String>[];
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final (nivel, nombre, xpReq) = niveles[index];
                final alcanzado =
                    controller.userProgress.xpTotal >= xpReq;
